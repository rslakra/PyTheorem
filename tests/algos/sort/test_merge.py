...
from adts.sort.base import SortOrder
from algos.sort.merge import MergeSort
...
class MergeSortTest(AbstractTestCase):

    @classmethod
    def setUpClass(cls):
        # set app at class level
        cls.instance = MergeSort()
        logger.debug("MergeSortTest(), instance=%s", type(cls.instance))
